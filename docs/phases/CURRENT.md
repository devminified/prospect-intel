...
- Locked decisions (what's in scope, what's explicitly deferred)
- Budget expectations
- Anything the agent needs to know to make judgment calls

When the phase ships, compress this file to ≤ 20 lines, move the full spec to `archive/phase-N-<name>.md`, and return this file to "Active: none."
